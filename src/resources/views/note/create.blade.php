            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form class="w-full max-w-lg p-6">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        ...
                        <textarea class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="text" placeholder=""></textarea>
                        </div>
                    </div>
                </form>
            </div>
